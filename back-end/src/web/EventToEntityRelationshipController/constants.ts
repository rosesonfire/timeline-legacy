...
const SCHEMA__EVENT_TO_ENTITY_RELATIONSHIP__RESPONSE = {
  type: 'object',
  properties: {
    ...ID_SCHEMA,
    ...TYPE_SCHEMA,
...
export const SCHEMA__EVENT_TO_ENTITY_RELATIONSHIP__POST: Schema = {
  body: {
    type: 'object',
    properties: {
      ...NAME_SCHEMA,
  ...
  response: {
    200: SCHEMA__EVENT_TO_ENTITY_RELATIONSHIP__RESPONSE,
  },
};
